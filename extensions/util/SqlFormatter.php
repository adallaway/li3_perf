...
class SqlFormatter
{
    ...
    protected static function init() {
        ...
        usort(self::$reserved, array('li3_perf\extensions\util\SqlFormatter', 'sortLength'));

        // Set up regular expressions
        self::$regex_boundaries = '('.implode('|',array_map(array('li3_perf\extensions\util\SqlFormatter', 'quote_regex'),self::$boundaries)).')';
        self::$regex_reserved = '('.implode('|',array_map(array('li3_perf\extensions\util\SqlFormatter', 'quote_regex'),self::$reserved)).')';
        self::$regex_reserved_toplevel = str_replace(' ','\\s+','('.implode('|',array_map(array('li3_perf\extensions\util\SqlFormatter', 'quote_regex'),self::$reserved_toplevel)).')');
        self::$regex_reserved_newline = str_replace(' ','\\s+','('.implode('|',array_map(array('li3_perf\extensions\util\SqlFormatter', 'quote_regex'),self::$reserved_newline)).')');
